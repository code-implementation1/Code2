...
def mean_ap(
    ...
    Args:
       ...
       gallery_cams: numpy array with shape [num_gallery]
       average: whether to average the results across queries
       check_version: show warnings about scikit-learn version
    Returns:
       If `average` is `False`:
    ...
    if check_version:
        ...
        if cur_version != required_version:
            print(
                f'User Warning: Version {required_version} is required for package scikit-learn, '
                f'your current version is {cur_version}. '
                f'As a result, the mAP score may not be totally correct. '
                f'You can try `pip uninstall scikit-learn` '
                f'and then `pip install scikit-learn=={required_version}`'
            )
    # -------------------------------------------------------------------------
